$(document).ready(function () {
    ...
    document.title = 'POM - ' + params.title;
    ...
    console.log('loading local pom');
    App.loadScript('_site/js/pom.min.js', 'pom',onPOMLoaded)
    ...
    {
        if (!pixiLoaded || !pomLoaded)
        {
            return;
        }
        pixiLoaded = pomLoaded = false;
        console.log('pixi and POM loaded');
